var Main = React.createClass({displayName: "Main",
  ...
  // Initialize State of component
    ...
    render: function () {
          ...
          this.state.selectedProgressBar  = this.state.progressBars[0].id;
      ...
      React.createElement("div", {className: "col-sm-3"}, 
       React.createElement("select", {ref: "progressBarsSelection", onChange: this.handleChange, value: this.state.progressBars[0].id}, 
